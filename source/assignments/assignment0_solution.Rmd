...
A slight difference may be observed between the simulation-based estimate of the variance and the analytically computed true variance.
...
For a continuous variable, $Prob(450<X<550)$ and $Prob(450\leq X\leq 550)$ lead to the same probability.
...
qnorm(0.30,mean=500,sd=50, lower.tail = F)
