...
```{r modelest, cache = T, warning=F, message=F}
...
```{r eval = params$solution, echo = params$solution, cache = T}
...
```{r modelpostpred, eval = params$solution, echo = params$solution, cache = T, warning=T, message=T}
