---
title: "Assignment 3 - with responses"
...
```{r model_1, results="hide", cache = T}
sim_model <- brm(y ~ 1,
  data = sim_dat,
  family = gaussian(),
  prior = c(
...
```{r postpredviz2, cache =T, fig.asp = .5, dpi = 150, out.width=600}
...
```{r postpredviz1, cache =T, fig.asp = .5, dpi = 150, out.width=600}
