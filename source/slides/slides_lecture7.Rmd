...
Reaction times (RTs) are one of the most common outcome variables in cognitive psychology
...
bprior <- c(prior(normal(0, 3), class = Intercept)
            ...
            , prior(uniform(0, min_RT), class = ndt, ub = min_RT))
...
- $\tau$ (`ndt`) is interpretable in seconds, it's the estimated bound below which no response is possible
