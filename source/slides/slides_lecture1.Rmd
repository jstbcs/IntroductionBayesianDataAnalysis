...
```{r out.width = "40%"}
include_graphics("src/Julia.jpeg")
```

```{r out.width = "40%"}
include_graphics("src/Anne.jpeg")
```

```{r out.width = "40%"}
include_graphics("src/Leonardo.jpg")
```
]
...
.pull-right-45[
```{r out.width = "85%"}
include_graphics("src/frank4.jpeg")
```
